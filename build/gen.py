...
def scripts_html(spec):
    tags = ['<script src="/assets/js/engine.js?v=1" defer></script>',
            '<script src="/assets/js/share-card.js?v=1" defer></script>']
    for s in spec["scripts"]:
        tags.append(f'<script src="{s}?v=1" defer></script>')
    return "\n".join(tags)
...
<link rel="stylesheet" href="/assets/css/arcade.css?v=1">
